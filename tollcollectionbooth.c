...
void welcome()
{
	...
	drawstring(180, 260, 0.0, "6thsem CSE Students");
...
void frontscreen()
{
	...
	glColor3f(0.0, 0.0, 0.0);
	drawstring1(20, 320, 0.0, "STUDENT NAME - USN");
	glColor3f(0.0, 0.0, 1.0);
	drawstring2(20, 265, 0.0, "  VANDANA PANCHAGAVI- 2KA18CS056 ");
	drawstring2(20, 290, 0.0, "  POOJA N C         - 2KA18CS031 ");
	glColor3f(1.0, 1.0, 1.0);
	drawstring1(10, 230, 0.0, "Under the Guidance of");
	glColor3f(0.0, 1.0, 0.0);
	drawstring2(20, 200, 0.0, "Prof. Srikanta Jogar");
	glColor3f(0.0, 0.0, 0.0);
